    ...
    void signUp() {
        try {
            ...
            if (resultSet.next()) {
                ...
                String sql = "INSERT INTO Professors (name, email, phone_number, address, password, skills) VALUES (?, ?, ?, ?, ?, ?)";
                int rowsInserted = dbHelper.executeUpdate(sql, name, email, phn, address, password, skills);
