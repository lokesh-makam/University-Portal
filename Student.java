...
public class Student extends Users {
            ...
            if (!hasFailedCourses) {
                ...
                if (resultSet.next()) {
                    ...
                    if (totalCredits > 0) {
                        ...
                        System.out.println("CGPA : " + String.format("%.2f", cgpa));  // Format CGPA to 2 decimal places
                        System.out.println("----------------------------------");
                    } else {
    ...
    void dropCourse() {
        try {
            String str="select * from Enrollments where  student_id= ?";
            ...
            String courseCode = Main.scanner.next();
            String query = "DELETE FROM Enrollments WHERE course_code = ? AND student_id = ?";
